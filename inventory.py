...
class Inventory:
    ...
    def addProduct(self, product: Product, quantity: int) -> None:
        ...
        product_quantity = self.__products.setdefault(product_name, [product, 0])
    ...
    def __parse(self) -> str:
        ...
        for product, quantity in self.__products.values():
            parsed_products[quantity] = product.parseProduct()
    ...
    def loadF(self) -> None:
        with open("a.json", "r") as file:
            ...
            for quantity, parsed_product in parsed_stock.items():
                ...
                self.__products[product.getProductName()] = [product, quantity]

    def getPriceFor(self, product_name: str):
        if product_name in self.__products:
            return self.__products[product_name][0].getProductPrice()
